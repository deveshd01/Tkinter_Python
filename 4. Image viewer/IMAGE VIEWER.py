...
image_no_2 = ImageTk.PhotoImage(Image.open("sample1.png")) 
image_no_3 = ImageTk.PhotoImage(Image.open("Sample2.png")) 
image_no_4 = ImageTk.PhotoImage(Image.open("sample3.png")) 
